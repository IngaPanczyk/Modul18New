...
public class TrelloClientTest {
    ...
    public void init(){
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("ingapanczyk");
    }
    @Test
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/ingapanczyk/boards?key=test&token=test&fields=name,id&lists=all");
    ...
    public void shouldCreateCard()throws URISyntaxException{
        ...
        //When
        CreatedTrelloCardDto newCard = trelloClient.creteNewCard(trelloCardDto);
